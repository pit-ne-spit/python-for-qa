...
def test_contact_data(app):
    ...
    assert selected_contact_on_home_page.all_phones_from_home_page == merge_phones_like_on_home_page(selected_contact_edit_page)
    assert selected_contact_on_home_page.all_emails == merge_emails_like_on_home_page(selected_contact_edit_page)
