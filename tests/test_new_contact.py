...
def test_new_contact(app):
    ...
    contact = Contact(firstname="Petr", middlename="V.", lastname="Arapov", nickname="pit_ne_spit", company_name="any",company_title="title of what?",
                                             ...
                                             secondary_phone="+79856998598", notes="no notes")
